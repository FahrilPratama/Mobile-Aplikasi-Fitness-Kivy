...
class WorkoutsBanner(GridLayout):
    ...
    def __init__(self, **kwargs):
        ...
        middle = FloatLayout()
        middle_date = Label(text=kwargs['date'], size_hint=(1, .2), pos_hint={"top": .975, "right": 1}, color=(0, 0, 0, 1))
        middle_image = Image(source=kwargs['type_image'], size_hint=(1, 0.5),
                             pos_hint={"top": .75, "right": 1})
        middle_label = Label(text=str(kwargs['number']) + " " + kwargs['units'], size_hint=(1, 0.2),
                             pos_hint={"top": .225, "right": 1}, color=(0, 0, 0, 1))
        ...
        right_image = Image(source="icons/likes.png", size_hint=(1, 0.8),
                            pos_hint={"top": 1, "right": 1})
        self.right_label = Label(text=str(kwargs['likes']) + " Disukai", size_hint=(1, 0.2),
